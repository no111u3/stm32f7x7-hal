...
use crate::stm32::{spi1, RCC, SPI1, SPI2, SPI3, SPI4, SPI5, SPI6};

use crate::gpio::{
    gpioa::{PA1, PA10, PA11, PA12, PA5, PA6, PA7, PA9},
    gpiob::{PB0, PB10, PB12, PB13, PB14, PB15, PB2, PB3, PB4, PB5, PB8},
    gpioc::{PC1, PC10, PC11, PC12, PC2, PC3, PC7},
    gpiod::{PD0, PD3, PD6},
